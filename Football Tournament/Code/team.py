...
class Player: #Player class , the object of this class will hold player information
...
class Team:#Team class , the object of this class will hold team information
    ...
    def add_new_player(self):#Defining a method to add a player to the team
        ...
        info = input('Enter player information: ')
        for player in self.players:
            if player.get_player_name() == player_name:
                print('Player already exists')
                return
        self.players.append(Player(player_name, info))
    def list_team_players(self):#Defining a method to list all players and their informtaion
        if len(self.players) == 0:
            return 'No players in the team yet'
        else:
            team_info = ''
            for player in self.players:
                team_info += 'Player Name: ' + player.get_player_name() + ' | ' + 'Player Information: ' + player.get_player_info() + '\n' + '\n'
            return team_info
